...
The reference canvas uses official Cubism Core for parameter-to-vertex evaluation. Its small comparison renderer supports normal/additive/multiplicative drawables but reports that mask composition is not yet a replacement for the full official Cubism Web Framework renderer.
