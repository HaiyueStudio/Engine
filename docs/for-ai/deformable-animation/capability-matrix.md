...
| Multiply/screen drawable color | 未进入 v1 payload | approximated | 未验收 | warning；strict failure |
| Culling | payload 保留但 v1 renderer 不执行 | ignored | 未验收 | warning；strict failure |
