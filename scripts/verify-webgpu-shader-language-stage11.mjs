...
assertPixel(result.litPixel, [255, 0, 0, 255], 1, 'litPixel', failures);
...
console.log(`[shader-language:stage11:webgpu] passed: passes=${result.passCount}, lit=${result.litPixel.join(',')}, fog=${result.fogPixel.join(',')}, module=${result.lightingModuleHash.slice(0, 12)}.`);
