...
if (createHash('sha256').update(common).digest('hex') !== '7aa6abf98fa3301187869e678c5a6d4dadf416e2edfcee443a125755572a239f') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
