...
if (createHash('sha256').update(common).digest('hex') !== 'd775c23dacaaf15b328fcb1987b4cbf87e023eb0c6cb72e0da6eb6d9d63d86ad') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
