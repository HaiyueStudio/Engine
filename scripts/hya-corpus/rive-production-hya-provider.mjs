...
if (createHash('sha256').update(common).digest('hex') !== 'b1f01a3318ee6aff459a2c3ca74ff70a97a14671a100a1d6d03c9cad9039a85a') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
