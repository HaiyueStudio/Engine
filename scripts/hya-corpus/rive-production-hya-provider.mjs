...
if (createHash('sha256').update(common).digest('hex') !== 'cdbd72f7ddfce2531a17734299e7958c4e1363aa2dad0c4ac515ac46b579f8b9') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
