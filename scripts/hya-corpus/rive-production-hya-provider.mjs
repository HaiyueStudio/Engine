...
if (createHash('sha256').update(common).digest('hex') !== '304b69b847f6deb4166db64735123089ee726bc7ed689478624de36b1e349b89') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
