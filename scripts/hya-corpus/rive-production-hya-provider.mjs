...
if (createHash('sha256').update(common).digest('hex') !== 'b65ba4a114402db66413de0d70971b2e389bb8b6d2c06e3ce21a047b685abfaf') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
