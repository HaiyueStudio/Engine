...
if (createHash('sha256').update(common).digest('hex') !== '471671da035297200ad2485167f436bfbaeb6b6bb6c4e2b4d638a62fcccb71dc') throw new Error('HYA capture provider dependency identity differs from its pinned revision.');
