...
if (createHash('sha256').update(common).digest('hex') !== 'efbe36b441512354174170d01deb91a27967d1feb55fa15f88749cde32784ebe') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
