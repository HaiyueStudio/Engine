...
if (createHash('sha256').update(common).digest('hex') !== 'b2cd995e163cd88d15bba02003bc81a64fd18af59becdc1db49d74396d699237') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
