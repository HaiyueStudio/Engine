...
if (createHash('sha256').update(common).digest('hex') !== '1240dac2b76df29f7f88b25d0627d3f618f5fc0992d4ae62359349fe59960836') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
