...
if (createHash('sha256').update(common).digest('hex') !== '68bb5388f98c4889952fe072e4bdec90c34bdcee598cd5035dd51ef88b82c614') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
