...
if (createHash('sha256').update(common).digest('hex') !== 'ad9372f67f0465b5e2754f434b2064158485b4f4f01838f037e3ed460214166f') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
