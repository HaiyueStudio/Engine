...
if (createHash('sha256').update(common).digest('hex') !== '624dc97f071eecfbbb474862dc4642ec4dd364e82945033d14a65f3214e83ad3') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
