...
if (createHash('sha256').update(common).digest('hex') !== 'b1d106011d0a5985ab7336cf1b2fecf89960c71357842b7a9e16338bdbd9cca9') throw new Error('Official capture provider dependency identity differs from its pinned revision.');
