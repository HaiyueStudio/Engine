// haiyue:deformation-pass forward-skinned
...
fn vs_main(input: VertexInput) -> VertexOutput {
  ...
  let skinnedPosition = skinPosition(position, joints, weights);
  let skinnedNormal = safeNormalize(skinNormal(input.normal, joints, weights));
  let worldPosition = object.model * skinnedPosition;
