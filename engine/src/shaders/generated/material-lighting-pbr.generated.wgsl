// haiyue:material-lighting-pass pbr
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
  ...
  if (!false && (material.clearcoatFlags.z & 1u) != 0u) {
  ...
  if (!false && (material.clearcoatFlags.z & 2u) != 0u) {
  ...
  if (false && (u32(material.transmissionVolumeFactors.w) & 1u) != 0u) {
  ...
  if (false && (u32(material.transmissionVolumeFactors.w) & 2u) != 0u) {
  ...
  if (false) { clearcoatNormal = resolveClearcoatNormal(input); }
